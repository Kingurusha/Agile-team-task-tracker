...
public class AuthenticationSuccess implements AuthenticationSuccessHandler, LogoutSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        if (LOG.isTraceEnabled()) {
            LOG.trace("Successfully authenticated employee {}", username);
        }
    ...
    private String getUsername(Authentication authentication) {
        ...
        return ((EmployeeDetails) authentication.getPrincipal()).getUsername();
    }
    ...
    public void onLogoutSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
                                Authentication authentication) throws IOException {
        if (LOG.isTraceEnabled()) {
            LOG.trace("Successfully logged out employee {}", getUsername(authentication));
        }
